...
map.getView().fit([-8218159.008448, 1089463.960950, -8092652.711593, 1173134.825520], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Geoportal Puntos de riesgo </h2>';
        return titleElement;
    })(),
